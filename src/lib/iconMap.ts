...
import { 
  ...
  BookOpen, GraduationCap, FlaskConical, Atom, Brain, Globe, Microscope, Calculator // Added new educational icons
} from 'lucide-react'; // 필요한 아이콘들을 전부 임포트

// 아이콘 이름 충돌을 피하기 위해 일부 아이콘에 별칭 사용
export const iconMap: Record<string, LucideIcon> = {
  Footprints, Dumbbell, Activity, Zap, 
  Heart: Heart, Star: Star, Flag, Settings, Edit, Trash2, PlusCircle, Camera, ListChecks, UserPlus, BarChart2, Lightbulb, Users, KeyRound, LogIn, ImageIcon: ImageIconLucide, School, MessageSquarePlus, MessageSquareX, Wand2, AlertTriangle, UserCircle2, CheckCircle, Palette, Save, ShieldAlert, CheckCircle2: CheckCircle2Icon, Target, TrendingUp, XCircle, RotateCcw, PlusSquare, Settings2,
  ChevronDown, CalendarIcon, MinusCircle, UploadCloud, Loader2, ChevronLeft, ChevronRight, Check, Circle, X, PanelLeft,
  Smile, Cat, Dog, Bird, Turtle, Rabbit, Fish, BugPlay, StarIcon: Star, Sun, Moon, Rocket, Diamond, Leaf, Flower2, HeartIcon: Heart, Cloud, Apple, Cherry, Ghost, Gamepad2, Sparkles: SparklesIcon, Pizza, ToyBrick, TreePine, CupSoda, Sandwich, Cookie,
